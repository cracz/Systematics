...
void calculateSystematics(TString order_n_str = "3")
{
  ...
  DetachedComparison* res = new DetachedComparison("res", res_new, res_old);
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
    {
      ...
      quadSum += res->v_vn_pp.at(ithBin).deltaAbsValSquared;
      /*
      if (ithBin < 2)
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
  {
    ...
    quadSum += res->v_vn_pm.at(ithBin).deltaAbsValSquared;
    /*
    if (ithBin < 2)
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
  {
    ...
    quadSum += res->v_vn_kp.at(ithBin).deltaAbsValSquared;
    /*
    if (ithBin == 0)
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
  {
    ...
    quadSum += res->v_vn_km.at(ithBin).deltaAbsValSquared;
    /*
    if (ithBin == 0)
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
  {
    ...
    quadSum += res->v_vn_yCM_00to10_pr.at(ithBin).deltaAbsValSquared;
    /*
    if (ithBin > 9)
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
  {
    ...
    quadSum += res->v_vn_yCM_40to60_pr.at(ithBin).deltaAbsValSquared;
    /*
    if (ithBin > 9)
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
  {
    ...
    quadSum += res->v_vn_yCM_HADES.at(ithBin).deltaAbsValSquared;
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
  {
    ...
    quadSum += res->v_vn_yCM_00to10_pr_symm.at(ithBin).deltaAbsValSquared;
    /*
    if (ithBin > 4 && ithBin < 15)
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
  {
    ...
    quadSum += res->v_vn_yCM_40to60_pr_symm.at(ithBin).deltaAbsValSquared;
    /*
    if (ithBin > 4 && ithBin < 15)
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
  {
    ...
    quadSum += res->v_vn_yCM_00to05_pr_symm.at(ithBin).deltaAbsValSquared;
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
  {
    ...
    quadSum += res->v_vn_yCM_05to10_pr_symm.at(ithBin).deltaAbsValSquared;
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
  {
    ...
    quadSum += res->v_vn_yCM_10to15_pr_symm.at(ithBin).deltaAbsValSquared;
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
  {
    ...
    quadSum += res->v_vn_yCM_15to20_pr_symm.at(ithBin).deltaAbsValSquared;
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
  {
    ...
    quadSum += res->v_vn_yCM_20to25_pr_symm.at(ithBin).deltaAbsValSquared;
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
  {
    ...
    quadSum += res->v_vn_yCM_25to30_pr_symm.at(ithBin).deltaAbsValSquared;
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
  {
    ...
    quadSum += res->v_vn_yCM_30to35_pr_symm.at(ithBin).deltaAbsValSquared;
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
  {
    ...
    quadSum += res->v_vn_yCM_35to40_pr_symm.at(ithBin).deltaAbsValSquared;
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
  {
    ...
    quadSum += res->v_vn_yCM_40to45_pr_symm.at(ithBin).deltaAbsValSquared;
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
  {
    ...
    quadSum += res->v_vn_yCM_45to50_pr_symm.at(ithBin).deltaAbsValSquared;
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
  {
    ...
    quadSum += res->v_vn_yCM_50to55_pr_symm.at(ithBin).deltaAbsValSquared;
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
  {
    ...
    quadSum += res->v_vn_yCM_55to60_pr_symm.at(ithBin).deltaAbsValSquared;
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
  {
    ...
    quadSum += res->v_vn_pT_00to10_pr.at(ithBin).deltaAbsValSquared;
    /*
    if (ithBin > 1)
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
  {
    ...
    quadSum += res->v_vn_pT_40to60_pr.at(ithBin).deltaAbsValSquared;
    /*
    if (ithBin > 1)
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
  {
    ...
    quadSum += res->v_vn_pT_bin6_pr_symm.at(ithBin).deltaAbsValSquared;
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
  {
    ...
    quadSum += res->v_vn_pT_bin7_pr_symm.at(ithBin).deltaAbsValSquared;
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
  {
    ...
    quadSum += res->v_vn_pT_bin8_pr_symm.at(ithBin).deltaAbsValSquared;
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
  {
    ...
    quadSum += res->v_vn_pT_bin9_pr_symm.at(ithBin).deltaAbsValSquared;
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
  {
    ...
    quadSum += res->v_vn_pT_bin10_pr_symm.at(ithBin).deltaAbsValSquared;
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
  {
    ...
    quadSum += res->v_vn_pT_bin11_pr_symm.at(ithBin).deltaAbsValSquared;
  ...
  for (int ithBin = 0; ithBin < bins; ithBin++)
  {
    ...
    quadSum += res->v_vn_pT_bin12_pr_symm.at(ithBin).deltaAbsValSquared;
